Ext.define('kokojump.view.producto.RegistroGastos', {
    extend: 'Ext.panel.Panel',
    xtype: 'wRegGastos',
    alias: 'widget.wRegGastos',
    requires: [
        'Ext.layout.container.HBox',
        'kokojump.view.producto.GastoController',
        'Ext.grid.*',
   ...
   // bodyPadding: 5,
    ...
    initComponent: function () {
        var store  = Ext.create('kokojump.store.Gastos');
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        padding : 10,
                        url : kokojump.util.Rutas.gastoGuardar,
                        layout: {
                            type: 'vbox',
                            pack: 'start',
                            align: 'stretch'

Ext.define('kokojump.view.admin.PanelConfigGeneral', {
    ...
    initComponent: function () {
        Ext.apply(this, {
                items: [
                        ...
                        padding: 10,
                        flex: 1,
                        url: kokojump.util.Rutas.configuracionesGuardar,
                        layout: {
                            type: 'vbox',
                            align :'stretch'
                        },
                        ...
                        buttons:[
                          ...
                          },
                          {
                              ...
                              glyph: kokojump.util.Glyphs.getGlyph('editar'),
        ...
        Ext.Ajax.request({
            ...
            success: function(response){
                var rsp = kokojump.util.Json.decodeJSON(response.responseText);

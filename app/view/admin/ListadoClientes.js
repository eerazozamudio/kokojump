Ext.define('kokojump.view.admin.ListadoClientes', {
    extend: 'Ext.panel.Panel',
    xtype: 'wRegClientes',
    alias: 'widget.wRegClientes',
    requires: [
        'Ext.layout.container.HBox',
        'kokojump.view.admin.ListadoClientesController',
        'Ext.grid.*',
    ...
    initComponent: function () {
        var storeClientes = Ext.create('kokojump.store.Clientes');
        ...
        Ext.apply(this, {
            ...
            },
            {
                ...
                items: [{
                    ...
                    itemId: 'myFrmCliente',
                    url : kokojump.util.Rutas.clienteGuardar,
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'stretch'

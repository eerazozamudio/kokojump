Ext.define('kokojump.view.admin.PanelLocales', {
    extend: 'Ext.panel.Panel',
    xtype: 'wRegLocales',
    alias: 'widget.wRegLocales',
    requires: [
        'Ext.layout.container.HBox','kokojump.view.admin.PanelLocalesController'
    ],
    layout: {
        type: 'hbox',
        pack: 'start',
        ...
        Ext.apply(this, {
            ...
            },
            {
                ...
                items: [{
                    ...
                    url : kokojump.util.Rutas.localActualizar,
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'stretch'

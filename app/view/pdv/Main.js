Ext.define('kokojump.view.pdv.Main', {
    ...
    initComponent: function () {
        me = this;
        var _storeDetalle = Ext.create('kokojump.store.tmpRegistroVenta');
        Ext.apply(me, {
    ...
    getItems: function (_storeDetalle, _numeromesa) {
        var storeNinos = Ext.create('kokojump.store.NinosTodos');
                ...
                items: [{
                        ...
                        tbar: [
                            ...
                            */
                            ...
                            {
                                xtype : 'textfield',
                                itemId : 'txtNombreApoderado',
                                fieldLabel : '<b>APODERADO</b>',
                                flex: 2  
                            },
                            {
                                xtype:'button',

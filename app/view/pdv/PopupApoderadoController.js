Ext.define('kokojump.view.pdv.PopupApoderadoController', {
    ...
    accionKeyPresDniApoderado:function( txt, e, eOpts){
        ...
        if(e.getCharCode()==13){
           ...
           if(dniApo != ''){
                ...
                Ext.Ajax.request({
                    url: kokojump.util.Rutas.buscarApoderado,
                    params: {
                        dni: dniApo
                    },
                    success: function(response){
                        ...
                        var resultado = kokojump.util.Json.decodeJSON(response.responseText);

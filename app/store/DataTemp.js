Ext.define('kokojump.store.DataTemp', {
...
Ext.define('kokojump.store.tmpRegistroVenta', {
    extend: 'Ext.data.Store',
    fields: [
        { name :'id',type:'int'},
...
Ext.define('kokojump.store.tmpRegistroHijo', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('kokojump.store.tmpProductos', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('kokojump.store.Pagos', {
    extend: 'Ext.data.Store',
    fields: [
        { name :'id',type:'int'},

Ext.define('kokojump.store.tree.MenuGeneral', {
    extend: 'Ext.data.Store',fields: ["id", "descripcion"],
    data: [{ id: 'test' }],proxy: { type: 'memory' }
});

Ext.define('kokojump.store.tree.kokojump', {
...
Ext.define('kokojump.store.tree.Administrador', {
    extend: 'Ext.data.TreeStore',
    root: {
        expanded: true,
        children: [
...
Ext.define('kokojump.store.tree.Usuarios', {
    extend: 'Ext.data.TreeStore',
    root: {
        expanded: true,
        children: [
